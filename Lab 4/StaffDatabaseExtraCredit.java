...
public class StaffDatabaseExtraCredit extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        viewButton.setOnAction(e -> {
            ...
            // use executeQuery() for select Statments
        });
        ...
        insertButton.setOnAction(e -> {
            ...
            // string to insert records
            String string = "INSERT into Staff (id, lastname, firstname, mi, address, city, state, telephone, email) values (?,?,?,?,?,?,?,?,?);";

            try{
                // declare and initialize preparedStatement
                PreparedStatement preparedStatement = connection.prepareStatement(string);

                // Using textField to insert values into records
