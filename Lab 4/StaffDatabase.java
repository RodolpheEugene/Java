    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        viewButton.setOnAction(e -> {
            try {
                ...
                if (rset.next()) {
                    lastNameField.setText(rset.getString("lastName")); // sets last name to to its corresponding textField
                    firstNameField.setText(rset.getString("firstName")); // sets first name to its corresponding textField
                    miField.setText(rset.getString("mi")); // sets mi to its corresponding textField
                    addressField.setText(rset.getString("address")); // sets address to its corresponding textField
                    cityField.setText(rset.getString("city")); // sets city to its corresponding textField
                    stateField.setText(rset.getString("state")); // sets State to its corresponding textField
                    telephoneField.setText(rset.getString("telephone")); // sets Telephone number to its corresponding textField
                    emailField.setText(rset.getString("email")); // sets email to its corresponding textField
